...
function website(){
    ...
    document.getElementById("description1").innerText = "A website I made about Ameland";
    document.getElementById("description2").innerText = "A webshop to buy and sell food";
...
function other(){
    ...
    document.getElementById("image4").style.backgroundImage = 'url("img/roger.png")';
    ...
    document.getElementById("title4").innerText = "Framing Roger";

    document.getElementById("tags1").innerHTML = "<p>Photoshop</p>";
    document.getElementById("tags2").innerHTML = "<p>C#</p>" +
        "                        <p>Unity</p>";
    document.getElementById("tags3").innerHTML = "<p>Adobe premiere pro</p>";
    document.getElementById("tags4").innerHTML = "<p>Adobe premiere pro</p>";
    ...
    document.getElementById("description4").innerText = "This is a video project about Roger";
}
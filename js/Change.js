...
document.getElementById("image9").style.backgroundImage = 'url("img/Schermafbeelding 2025-09-29 121335.png")';
...
document.getElementById("title9").innerText = "Archery VR";
...
document.getElementById("tags7").innerHTML = "<p>C#</p>"+ "<p>Unity</p>";
    ...
    document.getElementById("tags9").innerHTML = "<p>C#</p>"+ "<p>Unity</p>";
...
document.getElementById("description8").innerText = "Sell the banana or cake to the customer!";
document.getElementById("description9").innerText = "Shoot the targets!";
...
document.getElementById("link8").href ="BananaAndCake.html";
document.getElementById("link9").href ="ArcheryVR.html";
